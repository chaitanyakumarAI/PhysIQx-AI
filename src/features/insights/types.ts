import type { PhysIQScoreSnapshot, ScoreTrendPoint, ScoreTrendRange } from "@/types/score";
...
export interface InsightsData {
  /** Current score/delta/headline — the same snapshot shown on Home. Body
   *  Balance renders from `score.pillars` directly — no separate field. */
